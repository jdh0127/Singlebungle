...
.hobby_board{font-family: 'Nanum Gothic', sans-serif; width:680px; margin:0 auto;}
...
<form method="post" action="writedo" id="frm" name="frm" onsubmit="return false;">
<input type="hidden" name="nick" value="<%=session.getAttribute("loginUser")%>">
<input type="hidden" name="time" width="0" value="<%=today.format(date.getTime())%>">
<table align="center" class="hobby_board">
	<tr>
	<td><label>제목</label></td>
	<td colspan="2"><input type="text" name="title" id="title" size="40"></td>
	</tr>
	<tr>
	<td class="hobby_loc">분야</td>
...
<option value="기타">기타</option>
		...
		<td>
		<input type="button" id="savebutton" name="savebutton" onclick="submitContents(this)" value="글저장">
		
		</td>
	</tr>
	<tr>
		<td colspan="3" style="width:630px; height:412px;" class="hobby_textbox">
