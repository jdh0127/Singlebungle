<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="Whatsell.*"%>
...
<body>
	<form method="get" id="frm">
		...
		<table class="view">
			...
			<!-- 4행 -->
			<tr>
				<td colspan="3" class="titleview_con">${whathomes.content}</td>
			</tr>
<tr>
	...
	${whathomes.fav }
			...
			<tr>
				<td class="titleview_btns" colspan="3">
					<!-- 5행 버튼 --> <c:choose>
						<c:when
							test="${(loginUser eq 'admin') || (whathomes.nick==loginUser) }">
							<input type="button" value="목록" onclick="location.href='list'">
							<input type="button" value="글 수정"
								onclick="location.href='update?mid=${whathomes.mid}'">
							<input type="button" value="글 삭제"
								onclick="location.href='delete?mid=${whathomes.mid}'">
