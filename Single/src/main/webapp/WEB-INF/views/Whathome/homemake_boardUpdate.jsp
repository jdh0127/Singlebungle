...
/*                  oEditors.getById["ir1"].exec("PASTE_HTML",
 ...
 function submitContents(elClickedObj) {
	...
	<input type="hidden" name="mid" value="${whathomes.mid }">
	<table align="center" class="res_board_update_table">
	<tr>
	<td><label>제목
	</label></td>
	<td colspan="2"><input type="text" name="title" id="title" size="40" value="${whathomes.title }"></td>
	</tr>
	
	<tr>
	<td class="res_loc" colspan="3"><input type="button" id="savebutton" name="savebutton" onclick="submitContents(this)" value="수정하기">
		</td>
	</tr>
	<tr>
	<td colspan="3" style="width:630px; height:412px;" class="res_textbox">
 	<textarea name="content" id="content" rows="10" cols="100" style="width:620px; height:408px;" >${whathomes.content }</textarea>
