...
<html>
<head>
<!-- <link rel="stylesheet" type="text/css" href="Hobby/css/board.css"> -->
...
<tr>
	<td colspan="3" class="titleview">
		<label></label><p>[ ${hobbys.sort} ]</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ${hobbys.title }</p>
	</td>
</tr>
...
<c:choose>
<c:when test="${(loginUser eq 'admin') || (hobbys.nick==loginUser) }">
<input type="button" value="목록" onclick="location.href='list'">
<input type="button" value="글 수정" onclick="location.href='update?mid=${hobbys.mid}'">
<input type="button" value="글 삭제" onclick="location.href='delete?mid=${hobbys.mid}'">	
<input id="mybtn" name="<%=session.getAttribute("loginUser")%>" type="button" value="의견 보기">	

</c:when>
<c:otherwise>
<input class="titleview_listgo" type="button" value="목록" onclick="location.href='list'">
<input id="mybtn" name="<%=session.getAttribute("loginUser")%>" type="button" value="의견 보기">	
