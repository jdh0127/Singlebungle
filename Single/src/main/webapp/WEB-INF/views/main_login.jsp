            ...
            <h1><a href="#"><span>single벙글</span></a></h1>
                <div class="navi">
                	...
                	%>                     
                		...
                		<a href='mypage.jsp'><img src='img/mypage_btn.jpg' alt='마이페이지'></a>
                	
                	<%
                	}else{ 	// 세션의 키 값이 없으면

                    	%>  
                		<a href='#header'><img src='img/login_btn.gif' alt='로그인'></a>
                    ...
                    <div class="logininner">
                                ...
                                <!-- <p class="not_login">아이디 또는 비밀번호가 틀립니다. </p> -->
	                ...
	                <div class="joininner"><!-- joininner Start -->
	    						<div class="join_box">
	    							...
	    							<input type="text" value="" name="email" placeholder="이메일을 입력해주세요" maxlength="30" id="join_id">
	    							...
	    							<input type="text" name="birth" placeholder="생년월일을 입력해주세요" maxlength="20" id="join_birth">	
	    							<input type="text" name="phone" placeholder="폰번호를 입력해주세요" size="50" maxlength="20" id="join_phone">	
		...
		<div id="content">
			...
			<div class="contentinner">
				<div id="page1" class="page">
						<div>
                            <ul>
                                <li><a href="whateat/list"><img src="img/food_map.png" alt="혼자 먹을 식당" onclick="return session1()"></a></li>
                                <li><a href="whatpla/list"><img src="img/joy_map.png" alt="혼자 놀 장소"></a></li>
                            </ul>
				...
				<div id="page3" class="page">
						<div>
                            <ul>
                                ...
                                <li><a href="hobby/list"><img src="img/hobby.png" alt="취미"></a></li>
                            </ul>
                            <ul>
				...
				<div id="page4" class="page">
						<div><a href="honey/list"><img src="img/h1.png" alt="꿀팁"></a></div>
				</div>
...
//네비게이션
        $(".navi>ul>li").hover(function(){
            $(this).find("a").css({"border-bottom":"10px solid #dbb930","color":"#9a192b"});
        },function(){
            $(this).find("a").css({"border-bottom":"none","color":"#aaa"});
        });
