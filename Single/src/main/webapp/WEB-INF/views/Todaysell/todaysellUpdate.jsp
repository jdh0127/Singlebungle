...
<script type="text/javascript" src="../js/board_insert.js"></script> 
	...
	<input type="hidden" name="mid" value="${Todaysells.mid }">
	<table align="center" class="res_board_update_table">
	<tr>
	<td><label>제목
	</label></td>
	<td colspan="2"><input type="text" name="title" id="title" size="40" value="${Todaysells.title }"></td>
	</tr>
	...
	<td colspan="3" style="width:630px; height:412px;" class="res_textbox">
 	<textarea name="content" id="content" rows="10" cols="100" style="width:620px; height:408px;" >${Todaysells.content }</textarea>
