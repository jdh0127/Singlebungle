...
var ref = "${whatsells.mid}";
var ddd;
var board = "whatshare";
</script>
<body>
<form method="get" id="frm">
<input type="hidden" name="board_no" value="${whatsells.mid }">
<table class="view">
<!-- 1행 -->
<tr>
	<td colspan="3" class="titleview">
		<p>${whatsells.loc} ${whatsells.title }</p>
	</td>
</tr>
...
<!-- 5행 버튼 -->
<c:choose>
<c:when test="${(loginUser eq 'admin') || (whatsells.nick==loginUser) }">

<input type="button" value="목록" onclick="location.href='list'">
<input type="button" value="글 수정" onclick="location.href='update?mid=${whatsells.mid}'">
<input type="button" value="글 삭제" onclick="location.href='delete?mid=${whatsells.mid}'">	
...
<script type="text/javascript">
	$(".borad_content_header>span").html("쇼핑 공유");
	 $(".hub_sub_menu:eq(1)").slideDown(600); // 오늘은뭐하지 -----슬라이드 다운
</script>
</html>