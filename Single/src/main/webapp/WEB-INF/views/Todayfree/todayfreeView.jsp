...
<input type="hidden" name="board_no" value="${Todayfrees.mid }">
<table class="view">
<!-- 1행 -->
<tr>
	<td colspan="3" class="titleview">
		<p>${Todayfrees.loc} ${Todayfrees.title }</p>
	</td>
</tr>
...
<!-- 5행 버튼 -->
<c:choose>
<c:when test="${(loginUser eq 'admin') || (Todayfrees.nick==loginUser) }">

<input type="button" value="목록" onclick="location.href='list'">
<input type="button" value="글 수정" onclick="location.href='update?mid=${Todayfrees.mid}'">
<input type="button" value="글 삭제" onclick="location.href='delete?mid=${Todayfrees.mid}'">	
...
<script type="text/javascript">
	$(".borad_content_header>span").html("무료 나눔");
