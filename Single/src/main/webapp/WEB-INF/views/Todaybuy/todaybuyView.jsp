...
<input type="hidden" name="board_no" value="${Todaybuys.mid }">
<table class="view">
<!-- 1행 -->
<tr>
	<td colspan="3" class="titleview">
		<p>${Todaybuys.loc} ${Todaybuys.title }</p>
	</td>
</tr>
...
<!-- 5행 버튼 -->
<c:choose>
<c:when test="${(loginUser eq 'admin') || (Todaybuys.nick==loginUser) }">

<input type="button" value="목록" onclick="location.href='list'">
<input type="button" value="글 수정" onclick="location.href='update?mid=${Todaybuys.mid}'">
<input type="button" value="글 삭제" onclick="location.href='delete?mid=${Todaybuys.mid}'">	
...
<script type="text/javascript">
	$(".borad_content_header>span").html("삽니다");
