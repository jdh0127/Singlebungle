			...
			<div id="tx_sidebar" class="tx-sidebar">
				<div class="tx-sidebar-boundary">
					...
					<!-- 	<li class="tx-list">
						...
						<li class="tx-list">
							<div unselectable="on" id="tx_map" class="tx-map tx-btn-trans">
								<a href="javascript:;" title="지도" class="tx-text" onclick="sample5_execDaumPostcode()">지도</a>
							</div>
						</li>
						<li class="tx-list">
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="/resources/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="/resources/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
			<!-- 		<li class="tx-list">
...
<!-- 					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		...
		<!-- 	<div id="mapContainer" style="border-top:1px solid;">
...
<script type="text/javascript">
	var config = {
		...
		form: 'frm'+"",  //등록하기 위한 Form 이름 설정(혁진)
...
<script type="text/javascript">
	...
	function setForm(editor) {
        ...
        var content = editor.getContent(); //에디터에 입력한 내용을 가져온다 (혁진)
		
        // 본문 내용을 필드를 생성하여 값을 할당하는 부분
        /* var title = frm.getElementById(title).value; */
   	/* 	var textarea = document.createElement('textarea');
       	textarea.name = 'content';
        textarea.value = content; */
       $("#content").val(content); // id가 content인 textarea에 에디터 입력한 내용 추가(혁진)
...
<!-- <div><button onclick='saveContent()'>전송</button></div> -->
<!-- End: Saving Contents -->
...
<!-- Sample: Loading Contents -->
<!--  <textarea id="" style="display:none;">
...
function sample5_execDaumPostcode() {
    ...
    new daum.Postcode({
        oncomplete: function(data) {
			...
			var mapc = innerDoc.getElementById("map");  //iframe쪽에서 display:none으로 표시한 div 아이디 가져오는 부분(혁진)

			var position = new daum.maps.LatLng(37.537187, 127.005476); //지도의 중심좌표
			
				var mapContainer = mapc; //지도 div 지정 
		        mapOption = {
		            center: position, 
		            level: 3 // 지도의 확대 레벨
		        };
            ...
            // 주소로 좌표를 검색
             geocoder.addr2coord(data.address, function(status, result) {
                ...
                if (status === daum.maps.services.Status.OK) {
                	...
                	/* if(mapc.innerHTML != null){ 
                		mapc.empty(); //empty 시키는 부분 - 혁진 
        	    	...
        	    	var iwContent = '<p style="padding:5px;font-size:13px;">' +fullAddr + '</p>'; 
